#!/usr/bin/env bash
# Render all CallCards demo ads (ad-01 through ad-10).
# Run from the repo root: bash render-demo.sh
...
echo "=================================================="
echo " CallCards DEMO Ads — draft render ($TOTAL ads)"
echo "=================================================="
echo ""
